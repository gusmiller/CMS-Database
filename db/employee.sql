...
VALUES
	...
	(3, 'Felipe', 'Miller', 20, 47),
	(4, 'Mirtha', 'Miller', 43, 5),
	(5, 'Camelia', 'Miller', 15, NULL),
	(6, 'Jim', 'Anderson', 54, 1),
	(7, 'Andre', 'Matterman', 2, 47),
	(8, 'Andrew', 'Brannen', 17, 47),
	(9, 'Anne', 'Holness', 2, 47),
	(11, 'Elva', 'Beckwith', 24, 55),
	(12, 'Benton', 'Willard', 8, NULL),
	(13, 'Randy', 'McConnell', 17, NULL),
	(14, 'Brian', 'Foreman', 64, 55),
	(15, 'Bejamin', 'Pigeon', 25, NULL),
	(16, 'Tom', 'Smith', 65, NULL),
	(17, 'Cheryl', 'Litt', 17, 5),
	(18, 'Lori-Ann', 'Williams', 31, NULL),
	(19, 'Corey', 'Young', 57, 5),
	(20, 'Winnifred', 'House', 64, NULL),
	(21, 'Dale', 'Tingley', 46, NULL),
	(22, 'David', 'Pakyuz', 47, NULL),
	(23, 'David', 'Boulard', 37, 22),
	(24, 'Diane', 'Hale', 17, 22),
	(25, 'Dave', 'Black', 53, 22),
	(26, 'Donna', 'Boulard', 14, 22),
	(27, 'Ernie', 'Dods', 4, 55),
	(28, 'Erik', 'Tolonel', 62, NULL),
	(29, 'Esther', 'Neusy', 60, 55),
	(30, 'Fred', 'Williams', 21, NULL),
	(31, 'Geoff', 'Hearns', 44, 55),
	(32, 'Gretha', 'Hoddenbagh', 37, 55),
	(33, 'Glenn', 'Solomon', 16, 55),
	(36, 'Hilary', 'Boulard', 58, 22),
	(37, 'Joshua', 'Hale', 14, 47),
	(38, 'Hannah', 'Bacon', 9, 22),
	(39, 'Heidi', 'Boulard', 47, NULL),
	(40, 'Randy', 'Hale', 59, NULL),
	(41, 'Isabelle', 'Dassie', 35, 5),
	(42, 'Isaiah', 'Assist', 51, 5),
	(43, 'Jessica', 'Young', 37, 47),
	(44, 'John', 'Jesvin', 27, 47),
	(45, 'Jim', 'Griffin', 1, 1),
	(46, 'Jim', 'Dods', 50, 1),
	(47, 'James', 'Chang', 10, NULL),
	(48, 'Jody', 'Paquette', 31, 1),
	(49, 'John', 'Austin', 60, 47),
	(50, 'John', 'Unsworth', 40, 47),
	(51, 'John', 'Wilkinsong', 23, NULL),
	(52, 'Jonathan', 'Thomas', 38, NULL),
	(53, 'Julie', 'Hale', 36, 47),
	(54, 'Julie', 'Kruszelnicki', 29, 47),
	(55, 'Julie', 'Oldland', 52, NULL);
